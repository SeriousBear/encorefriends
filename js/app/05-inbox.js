// js/app/05-inbox.js
//
// InboxSheet — the messages + crew inbox (DMs, crew group threads, requests).
// One large, cohesive component; CrewCreate and the concert-detail sheet were
// split into 05b-threads.js. Loads before 09-main.js.
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <div
                          style={{
                            ...
                            overflow: "hidden",
                            textOverflow: "ellipsis",
                            color: t.unread ? "var(--fg2)" : "var(--fg4)",
                          }}
                        >
